...
var card = {
	remove: function remove() {
		var cardId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : all;
	...
	append: function append(newItem) {
		var cardsContainer = $('#cardsContainer');
		cardsContainer.append(newItem);
	},
	create: function create(cardItem) {
		var newCard = '<div class="col col-12 col-sm-6 col-md-4" id="' + cardItem.id + '">' + '<div class="card">' + '<div class="card__top">' + '<div class="card__remove" onclick="popup.show(\'remove\',' + '\'' + cardItem.id + '\'' + ')"><i class="fas fa-times"></i></div>' + '<div class="card__flex flex-box">' + '<div class="flex-box__item">' + '<div class="card__logo" style="background-color: ' + cardItem.logo + '">' + '</div>' + '</div>' + '<div class="flex-box__item">' + '<div class="card__name">' + cardItem.name + '</div>' + '<div class="card__brand">' + cardItem.brand + '</div>' + '</div>' + '</div>' + '</div>' + '<div class="card__middle">' + '<div class="card__image" style="background-color: ' + cardItem.img + '"></div>' + '</div>' + '<div class="card__bottom">' + '<div class="card__desc">' + '<p>' + cardItem.desc + '</p>' + '</div>' + '<div class="card__buttons">' + '<div class="button button-white">ACTION 1</div>' + '<div class="button button-white">ACTION 2</div>' + '</div>' + '</div>' + '</div>' + '</div>';
		return newCard;
	},
